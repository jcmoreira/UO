...
//           addtosystemjournal( '??????? ' + inttostr(GetQuantity(tmpid)) + ' regs');
//           tmpcnt := tmpcnt + 1;
//           if tmpcnt > 10 then
//             begin
//               addtosystemjournal('??????: ?? ???? ??????????? regs!');
//               wait(15000);
//             end;
...
//       if tmpid = 0 then break;
//       addtosystemjournal( '??????? ' + inttostr(GetQuantity(tmpid)) + ' dead woods');
//       tmpcnt := tmpcnt + 1;
//       if tmpcnt > 10 then
//         begin
//           addtosystemjournal('??????: ?? ???? ??????????? dead woods!');
//           wait(15000);
//         end;
...
//       end;
//       addtosystemjournal( '??????? ' + inttostr(GetQuantity(tmpid)) + tmpname);
//       tmpcnt := tmpcnt + 1;
//       if tmpcnt > 10 then
//         begin
//           addtosystemjournal('??????: ?? ???? ??????????? ????');
